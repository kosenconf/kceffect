...
ActiveRecord::Schema.define(version: 20120605025802) do
  ...
  add_index "contributions", ["user_id", "event_id"], name: "index_contributions_on_user_id_and_event_id", unique: true, using: :btree
  ...
  add_index "events", ["label"], name: "index_events_on_label", unique: true, using: :btree
  ...
  add_index "favorites", ["effect_id", "user_id"], name: "index_favorites_on_effect_id_and_user_id", unique: true, using: :btree
  add_index "favorites", ["effect_id"], name: "index_favorites_on_effect_id", using: :btree
  ...
  add_index "taggings", ["effect_id"], name: "index_taggings_on_effect_id", using: :btree
  add_index "taggings", ["tag_id", "effect_id"], name: "index_taggings_on_tag_id_and_effect_id", unique: true, using: :btree
